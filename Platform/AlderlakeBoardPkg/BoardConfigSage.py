...
class Board(BaseBoard):
    def __init__(self, *args, **kwargs):
        ...
        self.VERINFO_IMAGE_ID     = 'SB_SAGE'
        self.VERINFO_PROJ_MAJOR_VER = 1
        self.VERINFO_PROJ_MINOR_VER = 0
        self.VERINFO_SVN            = 1
        self.VERINFO_BUILD_DATE     = time.strftime("%m/%d/%Y")

        self.BOARD_NAME           = 'sage'
        ...
        self.FLASH_BASE_SIZE      = 0x01000000  # 16MB SPI Flash (Radxa X4 uses 16MB or 32MB, defaulting to 16MB for safety, verify user specs)
        ...
        # SAGE UART Debug
        # Defaulting to 0x0 (UART0) for now.
        ...
        self._CFGDATA_EXT_FILE = [self._generated_cfg_file_prefix + 'CfgDataInt_Sage.dlt']
